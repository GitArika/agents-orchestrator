...
**Onde isso virou decisão.** Unidade OA-05 (papel único auto-contido) da entrega do
orquestrador ágil: o orquestrador parou de declarar portões (setup/verify) numa cópia à
parte que podia divergir
...
**Onde isso virou decisão.** Unidade OA-13 (a medição adaptada) da entrega do orquestrador
ágil manteve os comentários do ClickUp como fonte, sem mudança, mesmo trocando as outras quatro
...
**Onde isso virou decisão.** A unidade OA-13 (a medição adaptada) da entrega do orquestrador
ágil foi além: com o número do PR já conhecido pela unidade (OA-08), a atribuição por merge passou a
